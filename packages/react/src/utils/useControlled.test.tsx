...
describe('useControlled', () => {
  ...
  it('warns when switching from uncontrolled to controlled', () => {
    ...
    expect(() => {
      ...
      'Anchor UI: A component is changing the uncontrolled value state of TestComponent to be controlled.',
    );
  });
  ...
  it('warns when switching from controlled to uncontrolled', () => {
    ...
    expect(() => {
      ...
      'Anchor UI: A component is changing the controlled value state of TestComponent to be uncontrolled.',
    );
  });
  ...
  it('warns when changing the defaultValue prop after initial rendering', () => {
    ...
    expect(() => {
      ...
      'Anchor UI: A component is changing the default value state of an uncontrolled TestComponent after being initialized.',
    );
  });
