 ...
 *
 * Documentation: [Anchor UI Checkbox](https://anchorui.com/react/components/checkbox)
 */
...
CheckboxRoot.propTypes /* remove-proptypes */ = {
   ...
   *
   * Must be used in a [Checkbox Group](https://anchorui.com/react/components/checkbox-group).
   * @default false
   */
