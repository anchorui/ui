  ...
  return (
    <div className="Header">
      <div className="HeaderInner">
        <NextLink href="/" className="HeaderLogoLink dark:text-white dark:invert text-black">
          <Logo aria-label="Anchor UI" />
        </NextLink>

        <div className="flex gap-6 max-show-side-nav:hidden">
          <a
            className="HeaderLink"
            href="https://www.npmjs.com/package/@anchor-ui/react"
            rel="noopener"
          >
            <NpmIcon />
            {VERSION}
          </a>
          <a className="HeaderLink" href="https://github.com/anchorui/ui/" rel="noopener">
            <GitHubIcon />
            GitHub
          </a>
        </div>
              ...
              <MobileNav.Popup>
                ...
                <MobileNav.Section>
                  ...
                  <MobileNav.List>
                    ...
                    <MobileNav.Item href="https://github.com/anchorui/ui/" rel="noopener">
