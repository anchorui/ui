...
Anchor UI leverages architectural patterns from the open-source Base UI project. While we appreciate their foundational work and architectural contributions, Anchor UI is an independent library with its own codebase, APIs, and roadmap. Learn more about Base UI [here](https://mui.com/base/).  
